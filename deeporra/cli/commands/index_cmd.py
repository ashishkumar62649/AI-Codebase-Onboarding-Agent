"""DeepOrra index <repo_path> — build and promote one local index generation."""

from typing import Optional

import typer

from deeporra.cli.dependencies import create_index_service, resolve_config
from deeporra.contracts import DiagnosticSeverity, IndexServiceProtocol, IndexState
