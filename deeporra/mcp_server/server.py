"""FastMCP-based read-only stdio server for deeporra.
...
SERVER_NAME = "DeepOrra-mcp"
SERVER_VERSION = "0.1.0"
SERVER_INSTRUCTIONS = (
    "Read-only repository intelligence for deeporra. "
    "All tools require a repository_root that has been indexed by deeporra. "
