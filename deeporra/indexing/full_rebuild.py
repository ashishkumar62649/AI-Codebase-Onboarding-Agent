...
from deeporra.indexing.sqlite_fts_persistence import run_step4_persistence
from deeporra.storage.chroma_store import ChromaStore, EXPECTED_DIMENSION
...
class FullRebuildCoordinator:
    ...
    def __init__(self, repo_path: str) -> None:
        self._workspace = Path(repo_path).resolve() / ".deeporra"
