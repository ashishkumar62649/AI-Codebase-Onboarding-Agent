"""Ignore rules — gitignore, DeepOrraignore, and hardcoded ignores."""
...
HARDCODED_IGNORED_DIRS = frozenset({
    ".git", ".deeporra", "node_modules", "__pycache__", ".venv", "venv",
})
...
IGNORE_FILE_NAMES = (".gitignore", ".deeporraignore")
...
class IgnoreRules:
    def __init__(self, repo_root: str):
        ...
        self._DeepOrraignore_patterns: list[str] = []
        ...
        for fname in IGNORE_FILE_NAMES:
            ...
            if os.path.isfile(path):
                try:
                    ...
                    if fname == ".deeporraignore":
                        self._DeepOrraignore_patterns = patterns
                    else:
    ...
    def is_ignored(self, path: str) -> bool:
        ...
        for pattern in self._DeepOrraignore_patterns:
