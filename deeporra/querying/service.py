"""Read-only query service for an already-indexed DeepOrra repository.
...
modifies repository source files, or creates .deeporra when it does not exist.
"""
...
class QueryService:
    """Read-only query service for a single DeepOrra indexed repository.
